"""
Runs the random forest classifier. Must manually adjust features added to feature set for each run.
"""
import ast
import csv
import os
...
def run_classifier():
    ...
    file = open('results/rf/results_' + str(datetime.datetime.utcnow()) + '.csv', 'w')
