"""
Runs the support vector machine (SVM) classifier. Must manually adjust features added to feature set for each run.
"""
import ast
import csv
import datetime
...
def run_classifier():
    ...
    file = open('results/svm/results_' + str(datetime.datetime.utcnow()) + '.csv', 'w')
